...
export default class Shows extends Component{
    ...
    fetchShows = () => 
    {
      ...
      const Url = `https://api.themoviedb.org/3/search/movie?api_key=8367b1854dccedcfc9001204de735470&language=en-US&query=${this.state.search}&page=1`
        fetch(Url)
            .then(data => data.json())
                .then(data => {
                    this.setState({
  ...
  return( 
    ...
    style={{padding: 10, maxWidth: '100%'}}>
        ...
        <View>
        <Text style={{textAlign:"center",marginBottom:15,fontSize:25,fontWeight:'200'}}>Seach Movies
                </Text>
          {this.fetchShows}
        <SearchBar
